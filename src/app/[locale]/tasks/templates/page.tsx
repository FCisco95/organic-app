  ...
  return (
    <PageContainer>
      <div className="max-w-4xl mx-auto space-y-8" data-testid="task-templates-page">
        <div className="rounded-2xl border border-organic-terracotta/20 bg-gradient-to-r from-organic-terracotta/10 via-white to-organic-yellow/10 p-6">
          <h1 className="text-2xl font-semibold text-gray-900">{t('title')}</h1>
          <p className="mt-1 text-sm text-gray-600">{t('templateSurfaceHint')}</p>
          <div className="mt-2 h-1 w-20 rounded-full bg-gradient-to-r from-organic-terracotta to-organic-yellow" />
        </div>
