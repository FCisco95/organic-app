  ...
  return (
    ...
    >
      ...
      {!isAuthenticated && (
        <Link
          href="/signup"
          className="group inline-flex flex-shrink-0 items-center gap-2 self-start whitespace-nowrap rounded-full bg-organic-terracotta-hover px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-organic-terracotta-active sm:self-auto"
        >
