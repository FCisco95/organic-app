  ...
  return (
    ...
    >
      <div className="relative">
        {/* Core shimmer */}
        <div className="h-3 w-3 rounded-full bg-organic-terracotta/60 animate-egg-shimmer" />
        {/* Outer glow */}
        <div className="absolute -inset-3 rounded-full bg-organic-terracotta/20 blur-md animate-egg-shimmer-glow" />
        {/* Sparkle particles */}
        ...
        <div className="absolute bottom-0 -right-1 h-1 w-1 rounded-full bg-organic-terracotta-light/70 animate-egg-sparkle-3" />
      </div>
    </div>
  );
}
