...
const WalletConnectDrawer = dynamic(() => import('./wallet-connect-drawer').then(m => m.WalletConnectDrawer), { ssr: false });
    ...
    return (
      <div className="relative">
        <button
          ...
          className={cn(
            'flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 min-h-[44px]',
