...
| 4.12 | Notifications | 6 | FIXED | S1 | [plan](plans/2026-03-22-notifications-qa-revamp.md) | `main` (6258547) | — |
...
|--------|---------|------------|
| **Next to revamp** | 4.12 Notifications | FIXED — 3 bugs fixed, ready for prototype-executor |
...
| 2026-03-22 | 4.12 Notifications | `main` (6258547) | — | 3 fixes (mobile bell overflow, dispute href, mark-all-read). Ready for revamp. |
