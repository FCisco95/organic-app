...
| 4.19 | Ideas Incubator | 15 | FIXED | S2 | [plan](plans/2026-03-23-ideas-incubator-qa-revamp.md) | `main` (e1fd0f5) | — |
...
|--------|---------|------------|
| **Next to revamp** | 4.19 Ideas Incubator | 2 bugs fixed — run prototype-executor for visual revamp |
